...
namespace PersonCleaner.Tasks
{
    ...
    /// </summary>
    public class PersonCleanerTask : IScheduledTask
    {
        private readonly ILibraryManager libraryManager;
        private readonly IFileSystem fileSystem;
        private readonly ILogger logger;

        public PersonCleanerTask(ILibraryManager libraryManager, IFileSystem fileSystem, ILogManager logManager)
        {
        ...
        public string Key => "PersonCleanerTask";
